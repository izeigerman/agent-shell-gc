...
Activity comes from `agent-shell`'s event stream, from typing in a shell or its
viewport, and, for worktrees, from saving a file or selecting a buffer inside
